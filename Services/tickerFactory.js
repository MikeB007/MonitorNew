Monitor.factory("tickerFactory", function() {
    var _leadsCAN=['cxr.to','fru.to','crh.to','UNS.TO','TRP.TO','REI.UN.TO','T.TO','DDC.TO','IFC.TO','POT.TO'];
    var _leadsUS=['aapl','AMGN','VRTX','rrc','nrg','DVN','APC','EQT','R','WDC','BHI','NAVI','WRK','CM'];
